...
app.use( express.urlencoded({ extended: true }) ); //tells my app that it can gather form data from front-end
...
//app is an instance of express (created at the top) which lets us create Restful routes with it
